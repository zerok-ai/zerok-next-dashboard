...
export const LIST_INTEGRATION_ENDPOINT = `/v1/u/cluster/{cluster_id}/integration`;

export const GET_INTEGRATION_ENDPOINT = `/v1/u/cluster/{cluster_id}/integration/{integration_id}`;

export const UPDATE_INTEGRATION_ENDPOINT = `/v1/u/cluster/{cluster_id}/integration/{integration_id}`;
