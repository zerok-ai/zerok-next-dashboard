...
export const SET_USER_PASSWORD_ENDPOINT = `/v1/p/user/password/set`;

export const LIST_SERVICES_ENDPOINT_V2 = `/v1/u/cluster/{id}/service/list?st=-5m`;

export const LIST_SERVICES_ENDPOINT = `/v1/u/cluster/{cluster_id}/service/list?st={range}`;

export const LIST_ISSUES_ENDPOINT = `/v1/c/{cluster_id}/axon/issue?st={range}&limit={limit}&offset={offset}`;
...
export const GET_ERROR_DETAILS_ENDPOINT = `/v1/c/axon/issue/error`;
